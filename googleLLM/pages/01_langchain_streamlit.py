...
agent = create_pandas_dataframe_agent(
    ...
    agent_executor_kwargs={
        ...
        "return_intermediate_steps": True,   # ★ 핵심: 중간 스텝 반환
    },
)
...
if user_q:
    ...
    # result["intermediate_steps"]는 (AgentAction, observation) 튜플들의 리스트
